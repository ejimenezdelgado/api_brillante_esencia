...
from resources.productos import ProductosResource
from resources.clientes import ClientesResource
from resources.facturas import FacturasResource
from resources.inventario import InventarioResource

# Agregamos los recursos a las rutas del API
api.add_resource(ProductosResource, '/productos', '/productos/<int:producto_id>')
